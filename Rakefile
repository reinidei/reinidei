...
GITHUB_REPONAME    = "reinidei/reinidei.github.io"
...
task :publish => [:generate] do
  Dir.mktmpdir do |tmp|
    ...
    system "git remote add gh-pages http://github.com/#{GITHUB_REPONAME}.git"
    system "git push gh-pages #{GITHUB_REPO_BRANCH} --force"
